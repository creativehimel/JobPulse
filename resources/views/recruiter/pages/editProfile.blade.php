                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="industry" name="industry" class="select2 form-select">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="ownership" name="ownership" class="select2 form-select">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="companySize" name="companySize" class="select2 form-select">
