                    ...
                    <div class="job-list-list mb-15">
                        <div class="list-recent-jobs">
                                ...
                                <div class="card-job-bottom mt-25">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-4 col-12 text-lg-end d-lg-block d-none">
                                            <span><img src="{{asset('frontEndAssets')}}/imgs/theme/icons/shield-check.svg" alt="jobhub"></span>
                                            <span class="ml-5"><img src="{{asset('frontEndAssets')}}/imgs/theme/icons/bookmark.svg" alt="jobhub"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-job hover-up wow animate__animated animate__fadeIn">
                                <div class="card-job-top">
                                    <div class="card-job-top--image">
                                        <figure><img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/page/job/n-digital.png" /></figure>
                                    </div>
                                    <div class="card-job-top--info">
                            ...
                            <div class="card-job hover-up wow animate__animated animate__fadeIn">
                                <div class="card-job-top">
                                    <div class="card-job-top--image">
                                        <figure><img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/page/job/n-digital2.png"></figure>
                                    </div>
                                    <div class="card-job-top--info">
