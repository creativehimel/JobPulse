                        ...
                        <div class="row">
                                ...
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-1.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_16.png" />
                                        ...
                                        <div class="card-2-bottom mt-30">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="tags text-lg-end">
                                                    ...
                                                    <a href="#" class="mt-10"><img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/theme/icons/bookmark.svg" /></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-3.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_14.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-4.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_13.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-5.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_1.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-6.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_3.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-7.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_5.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-8.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_6.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-9.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_7.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="card-blog-1 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <figure class="post-thumb mb-15">
                                        <a href="blog-single.html">
                                            <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/blog/blog-thumb-10.png" />
                                        </a>
                                    </figure>
                                    <div class="card-block-info">
                                        <div class="post-meta text-muted d-flex align-items-center mb-15">
                                            <div class="author d-flex align-items-center mr-30">
                                                <img alt="jobhub" src="{{asset('frontEndAssets')}}/imgs/avatar/ava_10.png" />
                                                <span>Sarah Harding</span>
                                            </div>
                                            <div class="date">
                                                <span><i class="fi-rr-edit mr-5 text-grey-6"></i>06 September</span>
                            ...
                            <div class="post-list-small">
                                <div class="post-list-small-item d-flex align-items-center">
                                    <figure class="thumb mr-15">
                                        <img src="{{asset('frontEndAssets')}}/imgs/blog/thumb-1.png" alt="">
                                    </figure>
                                    <div class="content">
                                ...
                                <div class="post-list-small-item d-flex align-items-center">
                                    <figure class="thumb mr-15">
                                        <img src="{{asset('frontEndAssets')}}/imgs/blog/thumb-2.png" alt="">
                                    </figure>
                                    <div class="content">
                                ...
                                <div class="post-list-small-item d-flex align-items-center">
                                    <figure class="thumb mr-15">
                                        <img src="{{asset('frontEndAssets')}}/imgs/blog/thumb-3.png" alt="">
                                    </figure>
                                    <div class="content">
                                ...
                                <div class="post-list-small-item d-flex align-items-center">
                                    <figure class="thumb mr-15">
                                        <img src="{{asset('frontEndAssets')}}/imgs/blog/thumb-4.png" alt="">
                                    </figure>
                                    <div class="content">
                                ...
                                <div class="post-list-small-item d-flex align-items-center">
                                    <figure class="thumb mr-15">
                                        <img src="{{asset('frontEndAssets')}}/imgs/blog/thumb-5.png" alt="">
                                    </figure>
                                    <div class="content">
