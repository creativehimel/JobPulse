                    ...
                    <form  action="{{route('educations.update', $education->id)}}" method="post">
                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('roll') is-invalid @enderror" type="text" name="roll" id="roll" value="{{$education->roll}}"/>
                                @error('roll')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('registration') is-invalid @enderror" type="text" name="registration" id="registration" value="{{$education->registration}}"/>
                                @error('registration')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('institute_name') is-invalid @enderror" type="text" name="institute_name" id="institute_name" value="{{$education->institute_name}}"/>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select id="degree_type_id" name="degree_type_id" class="select2 form-select @error('degree_type_id') is-invalid @enderror">
                                    ...
                                    @foreach ($degreeTypes as $degreeType)
                                        <option @if ($education->degree_type_id == $degreeType->id)
                                            selected
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select id="degree_level_id" name="degree_level_id" class="select2 form-select @error('degree_level_id') is-invalid @enderror">
                                    ...
                                    @foreach ($degreeLevels as $degreeLevel)
                                        <option @if ($education->degree_level_id == $degreeLevel->id)
                                            selected
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select id="result_type_id" name="result_type_id" class="select2 form-select @error('result_type_id') is-invalid @enderror">
                                    ...
                                    @foreach ($resultTypes as $resultType)
                                        <option @if ($education->result_type_id == $resultType->id)
                                            selected
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('result') is-invalid @enderror" type="text" name="result" id="result" value="{{$education->result}}" />
                                @error('result')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control @error('passing_year') is-invalid @enderror" type="text" name="passing_year" id="passing_year" value="{{$education->passing_year}}" />
                                @error('passing_year')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select id="duration" name="duration" class="select2 form-select @error('duration') is-invalid @enderror">
                                    ...
                                    @for ($i = 1; $i <= 6; $i++)
                                    <option @if ($education->duration == $i)
                                            selected
