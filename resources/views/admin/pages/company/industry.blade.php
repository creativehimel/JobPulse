...
@section('main_content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">All Industries</h4>
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($industries as $id => $industry)
                                        <tr>
                                            <td>{{++$id}}</td>
                                            <td>
                                                <span class="fw-medium">{{ucwords($industry->name)}}</span>
                                            </td>
                                            <td>{{Str::words($industry->description, 20)}}</td>
                                            <td>{{$industry->created_at->toFormattedDateString()}}</td>
                                            <td>
                                                <div class="dropdown">
                                                    <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></button>
                                                    <div class="dropdown-menu">
                                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="{{'#edit'.$industry->id.'Modal'}}">
                                                ...
                                                {{-- Edit Modal --}}
                                                <div class="modal fade" id="{{'edit'.$industry->id.'Modal'}}" data-bs-backdrop="static" tabindex="-2">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <form class="modal-content" method="POST" action="{{route('industries.update', $industry->id)}}">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <input type="text" id="permissionName" name="name" class="form-control" placeholder="Enter Permission Name" value="{{$industry->name}}">
                                                                        @error('name')
                                                                            @php
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <textarea class="form-control" name="description" id="decription" cols="30" rows="4">{{$industry->description}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <div class="modal fade" id="addModal" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <form class="modal-content" method="POST" action="{{route('industries.store')}}">
                @csrf
            <div class="modal-header">
